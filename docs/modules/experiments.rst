...
Often used measures, including the name that must be used, are:
 ...
 - Interpolated recall precision curves (`iprec_at_recall`). This is family of measures, so requesting this will
 produce `iprec_at_recall_0.00` `iprec_at_recall_0.10`, etc.
