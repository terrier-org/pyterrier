...
from pyterrier.terrier.java import configure, set_terrier_version, set_helper_version, enable_prf, extend_package, J, set_property, set_properties, run, version, check_version, check_helper_version
...
__all__ = [
    # java stuff
    'java', 'configure', 'set_terrier_version', 'set_helper_version', 'enable_prf', 'extend_package', 'J', 'version', 'check_version', 'check_helper_version',
