...
from pyterrier.terrier.retriever import Retrieve, FeaturesRetriever, TextScorer
...
TerrierRetrieve = deprecated(version='0.11.0', reason="use pt.terrier.Retriever() instead")(Retrieve)
BatchRetrieve = deprecated(version='0.11.0', reason="use pt.terrier.Retriever() instead")(Retrieve)
...
__all__ = [
    ...
    # retrieval
    'Retrieve', 'BatchRetrieve', 'TerrierRetrieve', 'FeaturesRetriever', 'FeaturesBatchRetrieve', 'TerrierRetrieve', 'TextScorer',
