...
init = deprecated(version='0.11.0', reason='No longer needed, java is started automatically. More warnings may follow. To force initialization early, use pt.java.init() instead.')(java.legacy_init)
