...
BM25_br = pt.terrier.Retrieve(index, wmodel="BM25")
...
```python
sdm_bm25 = pt.rewrite.SDM() >> pt.terrier.Retrieve(indexref, wmodel="BM25")
...
two_features = BM25_br >> ( 
  pt.terrier.Retrieve(indexref, wmodel="DirichletLM") ** 
  pt.terrier.Retrieve(indexref, wmodel="PL2") 
)
```
