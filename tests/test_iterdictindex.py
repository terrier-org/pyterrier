...
class TestIterDictIndexer(TempDirTestCase):
    ...
    def test_pretok_createindex3(self):
        from pyterrier.index import IndexingType
        self._make_pretok_index(3, IndexingType.CLASSIC)
    ...
    def test_pretok_createindex3_single_pass(self):
        from pyterrier.index import IndexingType
        self._make_pretok_index(3, IndexingType.SINGLEPASS)
