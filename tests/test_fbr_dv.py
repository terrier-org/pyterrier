...
class TestFeaturesBatchRetrieve(BaseTestCase):
    ...
    def test_fbr_reranking(self):
        ...
        pipe = firstpass >> pt.FeaturesBatchRetrieve(indexref, features=["WMODEL:DPH", "WMODEL:PL2"], method='docvectors')
    ...
    def test_fbr_reranking2(self):
        ...
        pipe1 = firstpass >> pt.FeaturesBatchRetrieve(indexref, features=["WMODEL:PL2", "WMODEL:Tf"], method='docvectors')
    ...
    def test_fbr_ltr(self):
        JIR = pt.java.autoclass('org.terrier.querying.IndexRef')
        indexref = JIR.of(self.here + "/fixtures/index/data.properties")
        retr = pt.FeaturesBatchRetrieve(indexref, ["WMODEL:PL2"], wmodel="DPH", method='docvectors')
    ...
    def test_fbr_example(self):
        ...
        fbr = pt.FeaturesBatchRetrieve(indexref, ["WMODEL:Dl", "WMODEL:PL2"], wmodel="BM25", method='docvectors') % 2
